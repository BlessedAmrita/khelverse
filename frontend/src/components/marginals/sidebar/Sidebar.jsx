...
//             const isActive = pathname === path || (path !== '/' && pathname.startsWith(path)); // Check for active link
//             return (
//               <Link
//                 key={name}
//                 href={path}
//                 className={`flex items-center space-x-2 py-2 pl-[5px] rounded
//         ${isActive ? 'text-apts-purple-light' : 'hover:bg-apts-purple-light'}
//       `}
//               >
//                 <Icon size={20} className={`${isActive ? 'text-apts-purple-light' : ''}`} />
