...
//     level: 'Elite Coach',
//     specialization:
//       'Professional cricket coach specializing in batting techniques and mental conditioning. Certified Level 3 coach with international experience.',
//     successRate: '92%',
//     athletesTrained: 150,
//   };
...
//       icon: User,
//       label: 'Age',
//       value: coachData.age.toString(),
//       editable: true,
//     },
//     {
//       icon: Calendar,
//       label: 'Experience',
//       value: `${coachData.experienceYears} Years`,
//       editable: true,
//     },
//     {
//       icon: Target,
...
//               onError={(e) => {
//                 e.target.src =
//                   'https://www.apc.edu.au/wp-content/uploads/2022/12/APC-EU-Educator-Placeholder.jpg';
//               }}
//             />
//           </div>

//           <div className='flex-1 text-center md:text-left'>
//             <h1 className='text-4xl md:text-5xl font-bold mb-2 font-sprintura text-white'> {coachData.name}</h1>
//             <div className='inline-flex items-center px-3 py-1 rounded-full bg-purple/20 text-purple-light mb-4'>
//               <span className='mr-2'>{coachData.sport}</span>
//             </div>
//             <div className='flex items-center justify-center lg:justify-start gap-2 mb-3'>
//                     <MapPin className='w-5 h-5 text-purple-light' />
//                     <span className='text-gray-300 text-lg'>{coachData.cityState}</span>
//                   </div>

//             <p className='text-muted-foreground max-w-2xl'>
//             Passionate {coachData.sport} coach focused on unlocking athletes' full potential through strategic training, mentorship, and 
                ...
                <div className='text-center'>
                  <div className='relative inline-block mb-6'>
                    <div className='w-48 h-48 rounded-full border-8 border-purple-500/30 flex items-center justify-center relative'>
                      ...
                      <div className='text-center z-10'>
                        <div className='text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-khelverse-purple'>
                          {/* Assuming 'athletesTrained' is a field you might add to coach document in future, or leave as hardcoded if not dynamic */}
                          {'N/A'}
                        </div>
                        <div className='text-purple-300 font-medium'>Athletes Trained</div>
                      </div>
